...
from article.apis import CategoryViewSet, TagViewSet, ArticleViewSet, CommentViewSet, CollectionViewSet, LikeViewSet
...
urlpatterns = [
    re_path(r'^api/', include((router.urls, 'article-api'), namespace='article-api')),  # 接口地址
