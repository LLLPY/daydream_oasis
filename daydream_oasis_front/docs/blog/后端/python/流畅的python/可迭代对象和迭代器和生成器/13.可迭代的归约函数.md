...
<BlogInfo title="13.可迭代的归约函数" author="白日梦想猿" pv=0 read_times=0 pre_cost_time=0分43秒 category="可迭代对象_迭代器和生成器" tag_list="['可迭代对象_迭代器和生成器']" create_time="2022.04.17 15:07:01" update_time="2022.04.17 15:23:16" />
