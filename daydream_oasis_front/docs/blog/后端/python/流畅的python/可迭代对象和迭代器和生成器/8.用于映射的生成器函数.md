...
<BlogInfo id="846" title="8.用于映射的生成器函数" author="白日梦想猿" pv=0 read_times=0 pre_cost_time="0分35秒" category="可迭代对象_迭代器和生成器" tag_list="['可迭代对象_迭代器和生成器']" create_time="2022.04.17 10:16:16" update_time="2022.04.17 12:06:26" />
