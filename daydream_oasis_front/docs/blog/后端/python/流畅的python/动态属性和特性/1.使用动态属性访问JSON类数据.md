...
<BlogInfo title="1.使用动态属性访问JSON类数据" author="白日梦想猿" pv=0 read_times=0 pre_cost_time=1分14秒 category="动态属性和特性" tag_list="['动态属性和特性']" create_time="2022.07.13 15:46:45" update_time="2022.07.13 16:41:33" />
