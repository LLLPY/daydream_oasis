...
<BlogInfo title="1.StudentManage" author="白日梦想猿" pv=0 read_times=0 pre_cost_time=19分49秒 category="学生成绩管理系统" tag_list="['学生成绩管理系统']" create_time="2020.08.16 11:27:11" update_time="2021.06.26 21:45:21" />
...
class Application(Frame):
    ...
    def test5(self):
        ...
        self.sb.config(command=self.text1.yview)  # sb.settings(command=lb.yview)
